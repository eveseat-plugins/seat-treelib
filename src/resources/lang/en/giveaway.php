<?php
return [
    "giveaway_card_title"   =>  "EVE Partner Giveaway",
    "giveaway_card_text"    =>  "The developer of this seat-module is part of the EVE Partner Program. This means monthly skin giveaways!
